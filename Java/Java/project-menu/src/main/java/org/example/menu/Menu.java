...
//    }
    ...
    public int screenConfirmOrder(String mapMenu, int mapHarga){
        System.out.println("==========================\n" +
                "Selamat datang di BinarFud\n" +
                "==========================\n" +
                "\n" +
    ...
    public int screenConfirmPayment(ArrayList<String> menuName, ArrayList<Integer> quantity, ArrayList<Integer> subTotal){
        System.out.println("==========================\n" +
